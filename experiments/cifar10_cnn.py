...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 12 11:56:59 2021
...
from pbms.models import CNN, ProbCNN
...
for d in depth:
    for w in width:
            ...
            ######## Prior means network ########
            # Train model
            prior = CNN(image_size, n_classes, w, d, 3, 1, device).to(device)
            ...
            # Train model
            prior2 = ProbCNN(image_size, n_classes, w, d, 3, 1, sigma_prior, True, prior, device).to(device)
            ...
            prob = ProbCNN(image_size, n_classes, w, d, 3, 1, sigma_prior, False, prior2, device).to(device)
            ...
            if save:
                results.to_csv(path + 'results_cifar10.csv')
